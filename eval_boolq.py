...
The files for evaluation come from the dataset's repository:
https://github.com/CogComp/Yes-No-or-IDK/tree/master/DATA/BoolQ_3L
...
Notice the files are in JSON format - CONVERT THEM TO JSONL.
...
def main():
    ...
    output_dir = args.output_dir or os.path.join("eval_results", "boolq3l", args.model_name_or_path)
